import api from './api';
import transformCase, { FinancialData, FinancialDataWithMeta, mapCamelToSnake } from './financialService';
...
export const promptService = {
  ...
  generateAIResponse: async (promptId: string, stockId: number, data: FinancialData): Promise<PromptResponse> => {
    const financialData: FinancialDataWithMeta = { stock_id: stockId, data: {} };
